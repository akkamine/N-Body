...
FMB_INLINE void body_array_Display_body(body_array_t *p_b,
...
/* NEW SPEED VECTOR SoA */

FMB_INLINE COORDINATES_T body_split_array_Get_sx(body_split_array_t *p_b, bodies_ind_t body_number){
  return p_b->p_sx[body_number];
}
FMB_INLINE COORDINATES_T body_split_array_Get_sy(body_split_array_t *p_b, bodies_ind_t body_number){
  return p_b->p_sy[body_number];
}
FMB_INLINE COORDINATES_T body_split_array_Get_sz(body_split_array_t *p_b, bodies_ind_t body_number){
  return p_b->p_sz[body_number];
}
FMB_INLINE void body_split_array_Set_sx(body_split_array_t *p_b, bodies_ind_t body_number, COORDINATES_T new_sx){
  p_b->p_sx[body_number] = new_sx;
}
FMB_INLINE void body_split_array_Set_sy(body_split_array_t *p_b, bodies_ind_t body_number, COORDINATES_T new_sy){
  p_b->p_sy[body_number] = new_sy;
}
FMB_INLINE void body_split_array_Set_sz(body_split_array_t *p_b, bodies_ind_t body_number, COORDINATES_T new_sz){
  p_b->p_sz[body_number] = new_sz;
}
FMB_INLINE void body_split_array_Set_speed(body_split_array_t *p_b, bodies_ind_t body_number, position_t *p_new_speed){
  body_split_array_Set_sx(p_b, body_number, position_Get_x(p_new_speed));
  body_split_array_Set_sy(p_b, body_number, position_Get_y(p_new_speed));
  body_split_array_Set_sz(p_b, body_number, position_Get_z(p_new_speed));
}
...
FMB_INLINE void body_split_array_Display_body(body_split_array_t *p_b,
					     bodies_ind_t body_number, 
					     FILE *f){
  position_t *speed_vector;
  position_Set_x(speed_vector,body_split_array_Get_sx(p_b, body_number));
  position_Set_y(speed_vector,body_split_array_Get_sy(p_b, body_number));
  position_Set_y(speed_vector,body_split_array_Get_sz(p_b, body_number));
...
typedef struct {
  ...
  COORDINATES_T *p_current_sx;
  COORDINATES_T *p_current_sy;
  COORDINATES_T *p_current_sz;
} body_split_array_it_t;
...
FMB_INLINE void body_split_array_it_Initialize(body_split_array_it_t *p_i, body_split_array_t *p_b){
  ...
  p_i->p_current_sx = p_b->p_sx;
  p_i->p_current_sy = p_b->p_sy;
  p_i->p_current_sz = p_b->p_sz;
}
...
/* New Speed Vector */
FMB_INLINE COORDINATES_T body_split_array_it_Get_sx(body_split_array_it_t *p_i){
  return *(p_i->p_current_sx);
}
FMB_INLINE COORDINATES_T body_split_array_it_Get_sy(body_split_array_it_t *p_i){
  return *(p_i->p_current_sy);
}
FMB_INLINE COORDINATES_T body_split_array_it_Get_sz(body_split_array_it_t *p_i){
  return *(p_i->p_current_sz);
}
FMB_INLINE void body_split_array_it_Set_sx(body_split_array_it_t *p_i, COORDINATES_T new_sx){ 
  *(p_i->p_current_sx) = new_sx;
}
FMB_INLINE void body_split_array_it_Set_sy(body_split_array_it_t *p_i, COORDINATES_T new_sy){ 
  *(p_i->p_current_sy) = new_sy;
}
FMB_INLINE void body_split_array_it_Set_sz(body_split_array_it_t *p_i, COORDINATES_T new_sz){ 
  *(p_i->p_current_sz) = new_sz;
}
FMB_INLINE void body_split_array_it_Set_speed_vector(body_split_array_it_t *p_i, position_t *p_new_speed_vector){ 
  body_split_array_it_Set_sx(p_i, position_Get_x(p_new_speed_vector));
  body_split_array_it_Set_sy(p_i, position_Get_y(p_new_speed_vector));
  body_split_array_it_Set_sz(p_i, position_Get_z(p_new_speed_vector));
}
/* Old Speed vector
...
FMB_INLINE void body_split_array_it_Display_body(body_split_array_it_t *p_i, FILE *f){
  ...
  position_t *speed_vector=NULL;
  position_Set_x(speed_vector,body_split_array_it_Get_sx(p_i));
  position_Set_y(speed_vector,body_split_array_it_Get_sy(p_i));
  position_Set_y(speed_vector,body_split_array_it_Get_sz(p_i));
...
FMB_INLINE void body_split_array_it_Get_body(body_split_array_it_t *p_i, body_t *p_body_out){
  ...
  position_Set_x(body_Get_p_speed_vector(p_body_out), body_split_array_it_Get_sx(p_i));
  position_Set_y(body_Get_p_speed_vector(p_body_out), body_split_array_it_Get_sy(p_i));
  position_Set_z(body_Get_p_speed_vector(p_body_out), body_split_array_it_Get_sz(p_i));
...
// speed vector
#define bodies_Get_sx(p_b, body_number) body_split_array_Get_sx(p_b, body_number)
#define bodies_Get_sy(p_b, body_number) body_split_array_Get_sy(p_b, body_number)
#define bodies_Get_sz(p_b, body_number) body_split_array_Get_sz(p_b, body_number)
#define bodies_Set_sx(p_b, body_number, new_sx) body_split_array_Set_sx(p_b, body_number, new_sx)
#define bodies_Set_sy(p_b, body_number, new_sy) body_split_array_Set_sy(p_b, body_number, new_sy)
#define bodies_Set_sz(p_b, body_number, new_sz) body_split_array_Set_sz(p_b, body_number, new_sz)
#define bodies_Set_speed(p_b, body_number, new_speed) body_split_array_Set_speed(p_b, body_number, new_speed)
// force vector
...
FMB_INLINE void copy_all_body_fields_NoS(COORDINATES_T *p_body_target_pos_x,
  ...
  *p_body_target_fz = body_src_fz;
  /*
  *p_body_target_sx = body_src_sx;
  *p_body_target_sy = body_src_sy;
  *p_body_target_sz = body_src_sz;
  */
...
FMB_INLINE void Copy_body2body_array(body_array_t *p_b_target,
				     ...
				     body_t *p_body){
  copy_all_body_fields_NoS(position_Get_p_x(body_array_Get_p_position(p_b_target, body_target_number)),
	         ...
	         position_Affect(body_array_Get_p_speed_vector(p_b_target, body_target_number), body_Get_p_speed_vector(p_body));
}
...
FMB_INLINE void Copy_body2body_split_array(body_split_array_t *p_b_target,
					   ...
					   body_t *p_body){
	/*position_t *speed_vector;
  position_Set_x(speed_vector,body_split_array_Get_sx(p_i));
  position_Set_y(speed_vector,body_split_array_Get_sy(p_i));
  position_Set_y(speed_vector,body_split_array_Get_sz(p_i));	*/		   
	
  copy_all_body_fields_NoS(p_b_target->p_pos_x + body_target_number,
		       position_Get_x(body_Get_p_position(p_body)),
		       ...
		       *(p_b_target->p_sx + body_target_number) = position_Get_x(body_Get_p_speed_vector(p_body));
		       *(p_b_target->p_sy + body_target_number) = position_Get_y(body_Get_p_speed_vector(p_body));
		       *(p_b_target->p_sz + body_target_number) = position_Get_z(body_Get_p_speed_vector(p_body));
}
...
FMB_INLINE void Copy_body_array2body_array(body_array_t *p_b_target,
  ...
  copy_all_body_fields_NoS(position_Get_p_x(body_array_Get_p_position(p_b_target, body_target_number)),
		       ...
		       position_Affect(body_array_Get_p_speed_vector(p_b_target, body_target_number), body_array_Get_p_speed_vector(p_b_src, body_src_number)); 
}
...
FMB_INLINE void Copy_body_split_array2body_split_array(body_split_array_t *p_b_target,
  ...
  copy_all_body_fields_NoS(p_b_target->p_pos_x + body_target_number,
		       ...
		       *(p_b_target->p_sx + body_target_number) = body_split_array_Get_sx(p_b_src, body_src_number);
		       *(p_b_target->p_sy + body_target_number) = body_split_array_Get_sy(p_b_src, body_src_number);
		       *(p_b_target->p_sz + body_target_number) = body_split_array_Get_sz(p_b_src, body_src_number);
}
...
#define bodies_it_Get_sx(p_i) body_split_array_it_Get_sx(p_i)
#define bodies_it_Get_sy(p_i) body_split_array_it_Get_sy(p_i)
#define bodies_it_Get_sz(p_i) body_split_array_it_Get_sz(p_i)
